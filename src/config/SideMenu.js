...
class SideMenu extends Component {
  ...
  async _callForLogoutAPI() {
    ...
    formData.append('carpenterId', this.carpenterId);
    ...
    await loginApiObj.logOut(formData,this.state.accesstoken);
  ...
  onPress2 = (lang) => {
    ...
    this.setState({
      menuList: [
        ...
        this.state.userType == 4 ? { title: strings('login.sidemenu_report'), nav1: 'ReportScreen' } : {},
        this.state.userType == 4 ? { title: strings('login.sidemenu_reporthistory'), nav1: 'ReportHistory' } : {},
