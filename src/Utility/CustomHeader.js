...
import { Vibration, NetInfo, Alert, AsyncStorage, BackHandler, Dimensions, Platform, StyleSheet, View, TextInput, Image, TouchableOpacity, StatusBar, Linking } from 'react-native';
    ...
    return(
      <View>
        <Header style={this.props.headerStyle}>
          <Left style={this.props.leftStyle}> 
            <TouchableOpacity onPress={()=> this.props.prop.navigation.navigate(this.props.leftNavigation)}> 
          ...
          <Right style={this.props.rightStyle}>{this.props.rightContent}</Right>
        </Header>
      </View>
    )}
  }
