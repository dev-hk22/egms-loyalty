...
var interval;
class DealerSignUpVerification extends React.Component {
    constructor(props) {
        super(props);
    ...
    async callForAPI() {
        ...
        var lUrl = app.URL + 'verifyRegistrationDealer';
        await fetch(lUrl, {
            method: 'POST',
            headers: {
    ...
    async _onPressResendOTP() {
        ...
        var lUrl = app.URL + 'resendRegOtpDealer';
        console.log(lUrl);
    ...
    backToLandingScreen = () => {
        Alert.alert(
            ...
            [
                ...
                // { text: 'YES', onPress: () => this.props.navigation.navigate('LandingScreen'), style: 'cancel' },
            ],
            { cancelable: false }
        );
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DealerSignUpVerification)