...
import { Alert, StatusBar, AsyncStorage, BackHandler, Dimensions, Platform, StyleSheet, View, TouchableOpacity, KeyboardAwareScrollView, FlatList } from 'react-native';
