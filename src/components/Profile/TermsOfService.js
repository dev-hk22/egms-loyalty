                ...
                <View style ={{ margin: 10}} >
                    <View style={{marginTop : 10}}>
                        <Text style={{fontWeight:"bold" , color : 'black',fontSize : 16}}>
                            Welcome to EGMS Verification!
                        </Text>
                        
                        <Text style={{marginVertical : 8 , fontSize : 14,lineHeight : 22}}>These Terms of Service ("Terms") govern your access to and use of the EGMS Verification mobile application ("App"). By registering for or using the App, you agree to be bound by these Terms. If you do not agree to all the Terms, you may not access or use the App.</Text>
                    </View>
                    ...
                    <View style={{marginTop : 10}}>
                        ...
                        <Text style={{marginVertical : 8,lineHeight : 22}}>In order to provide the functionalities of the EGMS Verification App, we may collect certain information from you, including:</Text>
                    ...
                    <View style={{marginTop : 10}}>
                        ...
                        <View style={{marginHorizontal : 7}}>
                            <Text style={{textAlign:'justify',fontSize : 13,lineHeight : 22}}>{'\u2B24'}  To verify the authenticity of products using the EGMS Verification App</Text>
                    ...
                    <View style={{marginTop : 10}}>
                        ...
                        By registering for or using the EGMS Verification App, you acknowledge that you have read, understood, and agree to be bound by these Terms.
                        </Text>
                    </View>
