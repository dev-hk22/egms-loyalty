...
class MechanicProfileScreen extends Component {
  ...
  async getAsyncUserData() {
    await AsyncStorage.multiGet(['USERDATA', 'ACCESSTOKEN'], (err, result) => {
      ...
      if (lData) {
        ...
        this.setState({
          carpenterId: lData.data.id,
          userType: lData.data.userType,
          accesstoken: at,
        });
        this._getUserData();
      }
  ...
  _onPressButton() {
    ...
    if (
      ...
      this.state.streetError == null &&
      this.state.pincodeError == null
    ) {
        ...
        <Header style={{backgroundColor: MyColors.distributorColor}}>
          ...
          <Body style={{flex: 0.9, paddingRight: 23}}>
            <Title style={{color: '#FFFFFF'}}>
              {strings('login.profile_screen_title')}
            </Title>
          </Body>
        </Header>
      );
          ...
          <Left style={{flex: 0.1}}>
            <TouchableOpacity
              ...
              <Icon
                type="FontAwesome5"
                name="arrow-left"
                style={{fontSize: 18, color: '#FFFFFF', paddingLeft: 10}}
              />
            </TouchableOpacity>
          </Left>
          ...
          <KeyboardAwareScrollView
            ...
            <Card
              style={{
                ...
                marginLeft: 10,
                marginRight: 10,
                backgroundColor: this.props.enableDarkTheme
                  ? '#1a1a1a'
                  : 'white',
              }}>
              <Content>
                <Form>
                  {!!this.state.nameError ? (
                    <Form>
                      <Item style={{borderColor: 'red', borderWidth: 1}}>
                        <Input
                          placeholder={strings(
                            'login.profile_screen_name_field',
                          )}
                          onFocus={() => {
                            this.setState({
                    ...
                    <Item floatingLabel>
                      <Label
                        ...
                        {strings('login.profile_screen_name_field')}
                      </Label>
                  ...
                  <Item floatingLabel>
                    <Label
                      ...
                      {strings('login.profile_screen_phn_field')}
                    </Label>
                    <Input
                  ...
                  {!!this.state.pincodeError ? (
                    <Form>
                      <Item style={{borderColor: 'red', borderWidth: 1}}>
                        <Input
                          maxLength={6}
                          placeholder={strings(
                            'login.profile_screen_pobox_field',
                          )}
                          onFocus={() => {
                            this.setState({
                              borderBottomColorUserName: '#50CAD0',
                    ...
                    <Item floatingLabel>
                      <Label
                        ...
                        {strings('login.profile_screen_pobox_field')}
                      </Label>
                      <Input
                        maxLength={6}
                        keyboardType={'number-pad'}
                  ...
                  <View
                    ...
                    <RNPicker
                      ...
                      selectedValue={(index, item) => {
                        this._setStates(item.name, this.statesList),
                          this.setState({state_name: item.name});
                      }}
                    />
                    {/* <Dropdown
                  ...
                  <View
                    ...
                    <RNPicker
                      ...
                      selectedValue={(index, item) => {
                        this._setCity(item.name, this.citiesList),
                          this.setState({city_name: item.name});
                      }}
                    />
                    {/* <Dropdown
                        ...
                        <TouchableOpacity
                          ...
                          <View
                            style={{
                              marginTop: 20,
                              marginBottom: 50,
                              backgroundColor: this.state.enable_edit
