...
class CustomerProfileScreen extends Component { //carpenter profile screen
    ...
    async callForAPI() {
        ...
        this.setState({ loading: true });
        await profileApiObj.updateProfileCustomer(formData,this.state.accesstoken);
        var lResponseData = profileApiObj.getRespData();
    ...
    _onPressButton() {
        ...
        if (lPincode === "") {
            this.setState({ pincodeError: strings('login.PoBoxError') });
            return;
        } else {
