...
export default class CustomerSignUpScreen extends Component {
    constructor(props) {
        super(props);
     ...
     signupDealer = () => {
        ...
        // }
            ...
            this.setState({ pincodeError: "", distributorCodeError: "", shopNameError: "", nameError: "", mobileNoError: "", addressError: "", stateError: "", cityError: "", loading: true, passwordError:"",confirmpasswordError:"",panNoError:"" }, () => {
                ...
                formData.append('vatGSTNo', this.state.vatgstno);
                ...
                var lUrl = app.URL + 'registerAuthUser';
                console.log(lUrl);
                ...
                fetch(lUrl, {
                    ...
                    .then((responseJson) => {
                        ...
                        if (responseJson.status == 200) {
                            ...
                            this.props.navigation.navigate('CustomerOtpVerification', 
                ...
                <View style={{ width: "100%", flex: 1,  justifyContent: "center", alignContent:'center' }}>
                    ...
                    <Form style={{ margin: 5}}>
                        ...
                        <Item stackedLabel style={{ marginTop: 5 }}>
                            <Label style={{ color: MyColors.distributorColor, fontSize: 16, }}>{strings('login.cust_profile_screen_name_field')}*:</Label>
                        ...
                        <Item stackedLabel style={{ marginTop: 5 }}>
                            ...
                            <Input placeholderTextColor="#ccc"  placeholder="Mobile Number" keyboardType="numeric" value={this.state.mobileNo} onChangeText={(e) => this.setState({ mobileNo: e.replace(/[^0-9]/g, '') })} />
                        </Item>
                        ...
                        <Item stackedLabel style={{ marginTop: 10 }}>
                            <Label style={{color: MyColors.distributorColor, fontSize: 16}}>{strings('login.cust_profile_screen_tax_field')}:</Label>
                            <Input placeholderTextColor="#ccc"  placeholder="VAT/GST No." value={this.state.vatgstno} onChangeText={(e) => this.setState({ vatgstno: e})} />
                        </Item>
                        {this.state.vatgstnoError.length > 0 ? <Text style={{ color: "red", textAlign: "center", }}>{this.state.vatgstnoError}</Text> : <View />}
