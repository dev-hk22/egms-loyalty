        ...
        fetch(lUrl, {
            ...
            .then((responseJson) => {
                ...
                if (responseJson.status == 200) {
                    this.setState({ outData: responseJson.out })
    ...
    render() {
        return (
            <ScrollView style={{ flex: 1, backgroundColor: this.props.enableDarkTheme ? 'black' : 'white' }}>
                ...
                {this.state.outData.length > 0 ? this.state.outData.map((data) => (
                        ...
                        {this.props.languageControl == 'Urdu - (اردو)' ?
                            <Grid>
                                <Row>
                                    ...
                                    <Col size={1.2} >
                                        <Text style={{ color: 'grey', fontSize: 18 }}>{strings('login.orderNumber')}:</Text>
                                    </Col>
                                </Row>
                                <Col>
...
export default connect(mapStateToProps, null)(OutScreen)