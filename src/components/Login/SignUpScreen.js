...
import { Alert, StatusBar, BackHandler, Dimensions, Platform, StyleSheet, View, TouchableOpacity, Picker } from 'react-native';
	...
	render() {
		...
		return (
			<View style={styles.container}>
				{this._showHeader()}
				<StatusBar barStyle="light-content" backgroundColor="#e43c22" />
