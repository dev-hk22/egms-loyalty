...
class LoginScreen extends Component { //carpenter login screen
  constructor(props) {
    super(props);
  ...
  async callForAPI() {
    ...
    if (!lResponseData) {
      ...
      try {
        ...
        this.props.navigation.navigate('HomeScreen', { mobileNumber: lMobileNumber});
      } catch (error) {
        console.log(error);
      }
    } else {
                  ...
                  <Content padder>
                    <TouchableOpacity onPress={() => this._onPressButton()}>
                      <View style={styles.buttonLogin}>
                        ...
                        {/* <LinearGradient colors={['#284b8b', '#284b8b', '#284b8b']} style={styles.linearGradient}> */}
                    ...
                    <View style={{ height: 300 }}>
                      <Card style={styles.cardContainer}>
                        ...
                        <View style={{ marginTop: 20 }}>
                          <Text>Enter your Email ID No to reset your password: </Text>
                          <TextInput
                            style={{
