...
import { AsyncStorage, BackHandler, Dimensions, Platform, StyleSheet, View, TouchableOpacity, StatusBar,Linking } from 'react-native';
  	...
  	async _getAsyncData(){
 		await AsyncStorage.getItem('USERDATA',(err,result)=>{		// USERDATA is set on SignUP screen
  			...
  			if (lData.user_type == '1') {
  				this.setState({ setNavigationScreen: 'VerifierMainScreen', backgroundColorHeader: '#e43c22'});
